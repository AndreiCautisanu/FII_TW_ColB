const containers = [
  ...
  },
  {
    ...
    description: 'This is a cobalt blue, about 6 7/8", squat, soda, beer or mineral water bottle.',
    price: 122.0,
    imageUrl: 'https://i.ebayimg.com/images/g/iVkAAOSwxcVimMOa/s-l1600.jpg',
    country: 'USA',
    year: 2016,
    type: 'Beer',
    hasLabel: true,
  ...
  },
  {
    ...
    description: 'Heineken Original Pure Malt Lager Beer with an Advertisement feel to it',
    price: 26.0,
    imageUrl:
...
const collections = [
  ...
  },
  {
    ...
    owner: 'Don',
    containers: [containers[0], containers[5], containers[6], containers[7], containers[8]],
  },
  {
    name: 'Wine blessing',
