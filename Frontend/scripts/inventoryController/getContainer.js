        ...
        <div class="container-details-container">
            ...
            ${
							...
							JSON.parse(localStorage.getItem('userData')).username
								? `<button class="delete-container-button" type="submit" onClick="deleteContainer(${containerData.id})"><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<button class="edit-container-button" type="submit" onClick="window.location.replace('\/Frontend\/edit-container.html?id=${containerData.id}')"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19.5361 7.33496L20.6211 6.27148C21.1689 5.72363 21.1904 5.13281 20.707 4.63867L20.3418 4.27344C19.8584 3.79004 19.2676 3.84375 18.7197 4.37012L17.6348 5.44434L19.5361 7.33496ZM6.87109 19.9678L18.5908 8.25879L16.7109 6.36816L4.98047 18.0879L3.95996 20.4727C3.86328 20.7305 4.13184 21.0312 4.38965 20.9238L6.87109 19.9678Z" fill="#E9F3FC" />
        </svg></button>`
								: ''
						}
       </div>
